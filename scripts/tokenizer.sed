...
#### MODIFIED:
#### - Removed EOS marker to allow for whole paragraph tokenization;
#### - Disabled tokenization of contractions.
...
# only.
#### ADAPTED FROM ORIGINAL. Removed end of string marker ($).
s=\([^.]\)\([.]\)\([])}>"']*\)[ 	]*=\1 \2\3 =g
